...
local vk_plat = require('dyadikos.vulkan.vk_platform')
...
local function VK_VERSION_MAJOR(version)
	return rshift(version, 22)
end

local function VK_VERSION_MINOR(version)
	return band(rshift(version, 12), 0x3ff)
end

local function VK_VERSION_PATCH(version)
	return band(version, 0xfff)
end
...
return { makeVersion = VK_MAKE_VERSION }
